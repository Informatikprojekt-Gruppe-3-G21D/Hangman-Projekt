# Library "random" importieren, um ein zufälliges Wort aus der Liste auszusuchen (sonst versteht der Computer nicht, was man später mit random.choice meint)
import random
...
print("Du stehst auf dem Marktplatz, die Menschenmasse drängt sich um dich und den dir drohenden Galgen. Sie werfen Tomaten und faule Eier auf    dich, fluchen und spucken. Du fürchstest dich, hast mit deinem Leben bereits abgeschlossen. Doch nein, das darf nicht sein. Du bist        unschuldig, warst zur falschen Zeit am falschen Ort! Deine Willenskraft kehrt zurück: ")
print("")
